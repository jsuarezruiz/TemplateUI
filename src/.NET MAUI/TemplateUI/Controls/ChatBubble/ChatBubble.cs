...
namespace TemplateUI.Controls
{
    public class ChatBubble : TemplatedView
    {
        ...
        public static new readonly BindableProperty BackgroundColorProperty =
            BindableProperty.Create(nameof(BackgroundColor), typeof(Color), typeof(ChatBubble), Colors.Transparent);
        ...
        public static readonly BindableProperty TextColorProperty =
            BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(ChatBubble), Colors.Transparent);
