...
namespace TemplateUI.Controls
{
    ...
    public class CircleProgressBar : TemplatedView
    {
        ...
        public static readonly BindableProperty ProgressColorProperty =
            BindableProperty.Create(nameof(ProgressColor), typeof(Color), typeof(CircleProgressBar), Colors.Black);
        ...
        public static readonly BindableProperty TextColorProperty =
            BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(CircleProgressBar), Colors.Black);
