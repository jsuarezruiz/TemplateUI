...
namespace TemplateUI.Controls
{
    public class ToggleSwitch : TemplatedView
    {
        ...
        public static readonly BindableProperty ThumbColorProperty =
            BindableProperty.Create(nameof(ThumbColor), typeof(Color), typeof(ToggleSwitch), Colors.WhiteSmoke);
        ...
        public static readonly BindableProperty OnColorProperty =
            BindableProperty.Create(nameof(OnColor), typeof(Color), typeof(ToggleSwitch), Colors.DarkGray,
        ...
        public static readonly BindableProperty OffColorProperty =
            BindableProperty.Create(nameof(OffColor), typeof(Color), typeof(ToggleSwitch), Colors.LightGray,
                propertyChanged: OnColorPropertyChanged);
        ...
        public static readonly BindableProperty BorderColorProperty =
          BindableProperty.Create(nameof(BorderColor), typeof(Color), typeof(ToggleSwitch), Colors.Transparent);
        ...
        internal static readonly BindablePropertyKey CurrentColorPropertyKey =
            BindableProperty.CreateReadOnly(nameof(CurrentColor), typeof(Color), typeof(ToggleSwitch), Colors.Transparent);
