...
namespace TemplateUI.Controls
{
    ...
    public class AvatarView : TemplatedView
    {
        ...
        Grid _container;
        Image _image;
        Microsoft.Maui.Controls.Shapes.Geometry _imageClip;
        Label _initials;
        Shape _border;
        ...
        public static new readonly BindableProperty BackgroundColorProperty =
            BindableProperty.Create(nameof(BackgroundColor), typeof(Color), typeof(AvatarView), Colors.Transparent);
        ...
        public static readonly BindableProperty BorderColorProperty =
            BindableProperty.Create(nameof(BorderColor), typeof(Color), typeof(AvatarView), Colors.Transparent);
