...
namespace TemplateUI.Controls
{
    public class ComparerView : TemplatedView
    {
        ...
        public static new readonly BindableProperty BackgroundColorProperty =
            BindableProperty.Create(nameof(TargetView), typeof(Color), typeof(ComparerView), Colors.Transparent);
        ...
        public static readonly BindableProperty ColorProperty =
            BindableProperty.Create(nameof(Color), typeof(Color), typeof(ComparerView), Colors.Gray,
