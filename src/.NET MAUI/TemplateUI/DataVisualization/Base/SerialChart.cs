...
namespace TemplateUI.DataVisualization
{
    public abstract class SerialChart : TemplatedView
    {
        ...
        public static readonly BindableProperty AxisColorProperty =
            BindableProperty.Create(nameof(AxisColor), typeof(Color), typeof(SerialChart), Colors.Black);
        ...
        public static readonly BindableProperty ColorProperty =
          BindableProperty.Create(nameof(Color), typeof(Color), typeof(SerialChart), Colors.Black,
