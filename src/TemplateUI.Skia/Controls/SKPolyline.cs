...
{
    public class SKPolyline : SKShape
    {
        PointCollection _points;
        bool _fillMode;

        public SKPolyline() : base()
        {
        }
        ...
        {
            (bindable as SKPolyline)?.UpdatePoints((PointCollection)newValue);
        }
        ...
        {
            (bindable as SKPolyline)?.UpdateFillMode((FillRule)newValue == FillRule.EvenOdd);
        }
