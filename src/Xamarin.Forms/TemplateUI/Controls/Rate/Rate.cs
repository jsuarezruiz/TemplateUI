...
namespace TemplateUI.Controls
{
    public class Rate : TemplatedView
    {
        ...
        public static readonly BindableProperty UnSelectedFillProperty =
            BindableProperty.Create(nameof(UnSelectedFill), typeof(Color), typeof(Rate), Color.Default);
        ...
        public static readonly BindableProperty UnSelectedStrokeProperty =
            BindableProperty.Create(nameof(UnSelectedStroke), typeof(Color), typeof(Rate), Color.Black);
        ...
        void UpdateRateItems()
        {
            ...
            for (var i = 1; i <= ItemCount; i++)
            {
                ...
                _rateLayout.Children.Add(rateItem);
            }
        ...
        void UpdateIsReadOnly()
        {
            if (IsReadOnly)
            {
                foreach (var rateItem in _rateLayout.Children)
                    rateItem.GestureRecognizers.Clear();
            }
            else
            {
                foreach (var rateItem in _rateLayout.Children)
                {
                    ...
                    rateItem.GestureRecognizers.Add(tapGestureRecognizer);
                }
            }
        }
