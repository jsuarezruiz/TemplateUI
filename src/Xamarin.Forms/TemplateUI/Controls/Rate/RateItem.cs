...
namespace TemplateUI.Controls
{
    public class RateItem : TemplatedView
    {
        ...
        public static readonly BindableProperty SelectedFillProperty =
            BindableProperty.Create(nameof(SelectedFill), typeof(Color), typeof(RateItem), Color.FromHex("#F6C602"));
        ...
        public static readonly BindableProperty UnSelectedFillProperty =
            BindableProperty.Create(nameof(UnSelectedFill), typeof(Color), typeof(RateItem), Color.Default);
        ...
        public static readonly BindableProperty SelectedStrokeProperty =
            BindableProperty.Create(nameof(SelectedStroke), typeof(Color), typeof(RateItem), Color.FromHex("#F6C602"));
        ...
        public static readonly BindableProperty UnSelectedStrokeProperty =
            BindableProperty.Create(nameof(UnSelectedStroke), typeof(Color), typeof(RateItem), Color.Black);
