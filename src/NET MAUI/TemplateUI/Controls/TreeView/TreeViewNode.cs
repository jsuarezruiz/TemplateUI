...
namespace TemplateUI.Controls
{
    ...
    public class TreeViewNode : TemplatedView
    {
        ...
        public static new readonly BindableProperty BackgroundColorProperty =
            BindableProperty.Create(nameof(BackgroundColor), typeof(Color), typeof(TreeViewNode), Colors.Transparent,
                propertyChanged: CurrentChanged);
        ...
        public static readonly BindableProperty BackgroundColorSelectedProperty =
            BindableProperty.Create(nameof(BackgroundColorSelected), typeof(Color), typeof(TreeViewNode), Colors.Transparent,
                propertyChanged: CurrentChanged);
        ...
        public static readonly BindableProperty TextColorProperty =
            BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(TreeViewNode), Colors.Transparent,
                propertyChanged: CurrentChanged);
        ...
        public static readonly BindableProperty TextColorSelectedProperty =
            BindableProperty.Create(nameof(TextColorSelected), typeof(Color), typeof(TreeViewNode), Colors.Transparent,
                propertyChanged: CurrentChanged);
        ...
        internal static readonly BindablePropertyKey CurrentBackgroundColorPropertyKey =
            BindableProperty.CreateReadOnly(nameof(CurrentBackgroundColor), typeof(Color), typeof(TreeViewNode), Colors.Transparent);
        ...
        internal static readonly BindablePropertyKey CurrentTextColorPropertyKey =
            BindableProperty.CreateReadOnly(nameof(CurrentTextColor), typeof(Color), typeof(TreeViewNode), Colors.Transparent);
