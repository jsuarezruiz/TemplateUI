...
namespace TemplateUI.Controls
{
    public class SegmentedItem : TemplatedView
    {
        ...
        public static new readonly BindableProperty BackgroundColorProperty =
          BindableProperty.Create(nameof(BackgroundColor), typeof(Color), typeof(SegmentedItem), Colors.Transparent,
        ...
        BindableProperty.Create(nameof(BackgroundColorSelected), typeof(Color), typeof(SegmentedItem), Colors.Transparent);
        ...
        public static readonly BindableProperty TextColorProperty =
           BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(SegmentedItem), Colors.Transparent,
               propertyChanged: OnSegmentedItemPropertyChanged);
        ...
        public static readonly BindableProperty TextColorSelectedProperty =
            BindableProperty.Create(nameof(TextColorSelected), typeof(Color), typeof(SegmentedItem), Colors.Transparent);
        ...
        internal static readonly BindablePropertyKey CurrentBackgroundColorPropertyKey =
            BindableProperty.CreateReadOnly(nameof(CurrentBackgroundColor), typeof(Color), typeof(SegmentedItem), Colors.Transparent);
        ...
        internal static readonly BindablePropertyKey CurrentTextColorPropertyKey =
            BindableProperty.CreateReadOnly(nameof(CurrentTextColor), typeof(Color), typeof(SegmentedItem), Colors.Transparent);
