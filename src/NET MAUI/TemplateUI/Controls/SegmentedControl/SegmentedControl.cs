...
namespace TemplateUI.Controls
{
    ...
    public class SegmentedControl : TemplatedView
    {
        ...
        public static new readonly BindableProperty BackgroundColorProperty =
          BindableProperty.Create(nameof(BackgroundColor), typeof(Color), typeof(SegmentedControl), Colors.Transparent);
        ...
        BindableProperty.Create(nameof(BackgroundColorSelected), typeof(Color), typeof(SegmentedControl), Colors.Transparent);
        ...
        public static readonly BindableProperty BorderColorProperty =
            BindableProperty.Create(nameof(BorderColor), typeof(Color), typeof(SegmentedControl), Colors.Transparent);
        ...
        public static readonly BindableProperty TextColorProperty =
           BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(SegmentedControl), Colors.Transparent);
        ...
        public static readonly BindableProperty TextColorSelectedProperty =
            BindableProperty.Create(nameof(TextColorSelected), typeof(Color), typeof(SegmentedControl), Colors.Transparent);
        ...
        {
            if (segmentedItem.BackgroundColor == Colors.Transparent)
                segmentedItem.BackgroundColor = BackgroundColor;

            if (segmentedItem.BackgroundColorSelected == Colors.Transparent)
                segmentedItem.BackgroundColorSelected = BackgroundColorSelected;

            if (segmentedItem.TextColor == Colors.Transparent)
