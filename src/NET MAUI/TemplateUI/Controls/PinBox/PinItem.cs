...
namespace TemplateUI.Controls
{
    ...
    public class PinItem : TemplatedView
    {
        ...
        public static readonly BindableProperty ItemColorProperty =      
            BindableProperty.Create(nameof(ItemColor), typeof(Color), typeof(PinItem), Colors.Transparent,
                propertyChanged: OnPinItemPropertyChanged);
        ...
        public static readonly BindableProperty ItemColorFocusedProperty =
            BindableProperty.Create(nameof(ItemColorFocused), typeof(Color), typeof(PinItem), Colors.Transparent, 
                propertyChanged: OnPinItemPropertyChanged);
        ...
        public static readonly BindableProperty ItemBorderColorProperty =
            BindableProperty.Create(nameof(ItemBorderColor), typeof(Color), typeof(PinItem), Colors.Transparent, 
                propertyChanged: OnPinItemPropertyChanged);
        ...
        public static readonly BindableProperty ItemBorderColorFocusedProperty =
            BindableProperty.Create(nameof(ItemBorderColorFocused), typeof(Color), typeof(PinItem), Colors.Transparent, 
                propertyChanged: OnPinItemPropertyChanged);
        ...
        internal static readonly BindablePropertyKey CurrentItemColorPropertyKey = BindableProperty.CreateReadOnly(nameof(CurrentItemColor), typeof(Color), typeof(PinItem), Colors.Transparent);
        ...
        internal static readonly BindablePropertyKey CurrentItemBorderColorPropertyKey = BindableProperty.CreateReadOnly(nameof(CurrentItemBorderColor), typeof(Color), typeof(PinItem), Colors.Transparent);
        ...
        void UpdateCurrent()
        {
            CurrentItemColor = !IsFocused || ItemColorFocused == Colors.Transparent ? ItemColor : ItemColorFocused;
            CurrentItemBorderColor = !IsFocused || ItemBorderColorFocused == Colors.Transparent ? ItemBorderColor : ItemBorderColorFocused;
        }
    }
}
