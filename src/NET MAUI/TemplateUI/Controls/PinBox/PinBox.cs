...
namespace TemplateUI.Controls
{
    public class PinBox : TemplatedView
    {
        ...
        public static readonly BindableProperty ItemColorProperty =
            BindableProperty.Create(nameof(ItemColor), typeof(Color), typeof(PinBox), Colors.Transparent,
                propertyChanged: OnPinBoxChanged);
        ...
        public static readonly BindableProperty ItemColorFocusedProperty =
            BindableProperty.Create(nameof(ItemColorFocused), typeof(Color), typeof(PinBox), Colors.Transparent,   
                propertyChanged: OnPinBoxChanged);
        ...
        public static readonly BindableProperty ItemBorderColorProperty =
            BindableProperty.Create(nameof(ItemBorderColor), typeof(Color), typeof(PinBox), Colors.Transparent,
                propertyChanged: OnPinBoxChanged);
        ...
        public static readonly BindableProperty ItemBorderColorFocusedProperty =
            BindableProperty.Create(nameof(ItemBorderColorFocused), typeof(Color), typeof(PinBox), Colors.Transparent,
                propertyChanged: OnPinBoxChanged);
        ...
        protected override void OnApplyTemplate()
        {
            ...
            if (!_container.Children.Contains(_internalEntry))
            {
                ...
                // TODO: Update with new .NET MAUI versions
        ...
        void UpdatePinItems()
        {
            ...
            foreach(var children in _pinContainer.Children)
            {
                if(children is PinItem pinItem)
                {
                    ...
                    if (pinItem.ItemColor == Colors.Transparent)
                        pinItem.ItemColor = ItemColor; 
                    
                    if (pinItem.ItemColorFocused == Colors.Transparent)
                        pinItem.ItemColorFocused = ItemColorFocused;

                    if (pinItem.ItemBorderColor == Colors.Transparent)
                        pinItem.ItemBorderColor = ItemBorderColor;

                    if (pinItem.ItemBorderColorFocused == Colors.Transparent)
