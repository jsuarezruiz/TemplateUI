...
namespace TemplateUI.Controls
{
    ...
    public class Marquee : TemplatedView
    {
        ...
        public static new readonly BindableProperty BackgroundColorProperty =
            BindableProperty.Create(nameof(BackgroundColor), typeof(Color), typeof(Marquee), Colors.Transparent);
        ...
        public static readonly BindableProperty BorderColorProperty =
            BindableProperty.Create(nameof(BorderColor), typeof(Color), typeof(Marquee), Colors.Transparent);
