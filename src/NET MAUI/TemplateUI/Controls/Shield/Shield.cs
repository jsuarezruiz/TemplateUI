...
namespace TemplateUI.Controls
{
    public class Shield : TemplatedView
    {
        ...
        public static readonly BindableProperty ColorProperty =
            BindableProperty.Create(nameof(Color), typeof(Color), typeof(Shield), Colors.Transparent);
        ...
        public static readonly BindableProperty TextColorProperty =
            BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(Shield), Colors.Transparent);
